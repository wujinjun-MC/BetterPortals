...
public class PacketProxyProvider {
    ...
    static {
        serverEntityField = ReflectionUtil.findFieldByType(ChunkMap.TrackedEntity.class, ServerEntity.class);
        seenByField = ReflectionUtil.findFieldByType(ChunkMap.TrackedEntity.class, Set.class);
    }
